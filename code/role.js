...
var Role = {
	...
	_fn : [3,6,9,13,16,20,23,27,31,35,38,42,47,51,55,60,64,69,73,78,83,88,93,98,103,108,114,119,125,131,136,142,148,154,160,166,173,179,185,192,199,205,212,219,226,233,240,248,255,263,270,278,285,293,301,309,317,325,334,342,350,359,368,376,385,394,403,412,421,431,440,449,459,468,478,488,498,508,518,528,538,549,559,570,580,591,602,612,623,635,646,657,668,680,691,703,714,726,738,755,775,800],
	...
	updateProperties : function(){
		...
		this._criticalRate = 100 * (fn[RoleData.dexterity]/10000 + RoleData.luck/1000);
		this._extraGold = fn[RoleData.luck];
		this._eliteMonsterRate = (fn[RoleData.dexterity] + 250)/50;
		this._extraExp = 1+fn[RoleData.intelligence]/750;
		this._treasureRate = 10 + RoleData.luck/10;
	...
	countExp : function(){
		var monsterLevel = RoleData.mapLevel*5+2;
		var lv = RoleData.lv;
