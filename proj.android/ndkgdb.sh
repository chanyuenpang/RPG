APPNAME="1024"
APP_ANDROID_NAME="com.veewo.a1024"
...
# ... use paths relative to current directory
    ...
    APP_ROOT="$COCOS2DX_ROOT/samples/JavasCript/$APPNAME"
    APP_ANDROID_ROOT="$COCOS2DX_ROOT/samples/JavasCript/$APPNAME/proj.android"
fi
